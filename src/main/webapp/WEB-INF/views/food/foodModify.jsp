...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resource/css/food/foodModify.css">
					...
					<form id="form1" method="post" enctype="multipart/form-data">
						...
						<div class="item main_register_titlePrice_container">
							<div class="main_register_titlePrice_titleWrapper">
								...
								<div class="main_register_titlePrice_titleInput">
									<input type="text" maxlength='30' class="titlePrice_titleInput" id="titleInput" name="title" value="${food.title }">
								</div>
							</div>
						...
						<div class="item main_register_summernote_container">
							<div class="main_register_summernote">
								<textarea class="form-control" id="summernote" name="contents">${food.contents }</textarea>
							</div>
						</div>
						<div class="item main_register_address_container">
							<div class="main_register_address_wrapper">
								...
								<div class="main_register_address_addressInput">
									<input type="text" class="address_addressInput" id="addressInput" required name="address" value="${food.address }">
								</div>
							</div>
						...
						<div class="item main_register_button_container">
							<div class="main_register_button_wrapper">
								<div class="main_register_registerBtn">
									<button class="btn submit" id="submitButton2" name="submitBtn">삭제</button>
									
									<div class="main_register_registerBtn_submit_back">
										<div class="main_register_registerBtn_submit">
...
$(document).ready(function(){
	...
	$("#submitButton2").click(function (e) {
		...
		$("#form1").attr("action", "foodRemove").submit();
	});	
