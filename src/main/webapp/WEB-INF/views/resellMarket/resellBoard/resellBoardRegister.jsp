						...
						<div class="item main_register_titlePrice_container">
							...
							<div class="main_register_titlePrice_priceWrapper">
								...
								<div class="main_register_titlePrice_priceInput">
									<input type="number" class="titlePrice_priceInput" maxlength='9' oninput="maxLengthCheck(this)" value="0" id="priceInput" name="price" placeholder="가격을 입력해주세요">
								</div>
							</div>
						</div>
...
*/
			...
			function uploadSummernoteImageFile(file, el) {
				...
				data : data,
				type : "POST",
				url : appRoot + "/resellMarket/resellBoard/uploadSummernoteImageFile",
				contentType : false,
				...
				success : function(d) {
					...
					$("#resellFormRegister").append($("<input name='imageKey' type='hidden' />").val(d.imageKey));
